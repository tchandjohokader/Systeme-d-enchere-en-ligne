...
if(isset($_POST['submit'])){
    ...
    $sql = "INSERT INTO `article`(`image_article`, `nom_article`, `prix`, `descrip_article`, `id_categorie`, `id_user`) VALUES (?,?,?,?,?,?)";
    $query = $conn->prepare($sql);
...
<div class="container my-5">
    ...
    <div class="col-sm-6">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-3 d-grid">
                <a href="../html/Page_Acceuil.php" class="btn btn-primary" role="button">Annuler</a>
            </div>
        </div>
    </form>
</div>
